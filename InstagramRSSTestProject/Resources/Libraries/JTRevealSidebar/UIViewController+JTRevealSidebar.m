...
@interface UIViewController (JTRevealSidebarPrivate)
...
- (void)setRevealedState:(JTRevealedState)revealedState
{
    ...
    id <JTRevealSidebarDelegate> delegate = [self selectedViewController].navigationItem.revealSidebarDelegate;
...
- (void)animationDidStop2:(NSString *)animationID finished:(NSNumber *)finished context:(void *)context {
    ...
    id <JTRevealSidebarDelegate> delegate =
...
@implementation UINavigationController (JTRevealSidebar)
